<div class="span6">
    ...
    echo form_open('todo/create', $attributes);
    ?>
...
<div class="span4">
    <?php
    while(list($key, $todo_group) =each($todos)) {
        ?>
        <table class="table table-hover">
            ...
            <?php
            $i =0;
            foreach ($todo_group as $todo_item):
                $i++;
                ?>
                <tr>
                    <td><?php echo $i ?></td>
                    <td><?php echo $todo_item['todo_name'] ?></td>
                    <td><?php echo $todo_item['target_name'] ?></td>
                </tr>
            <?php endforeach ?>
            </tbody>
        </table>
